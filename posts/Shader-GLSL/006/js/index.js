...
let scene, camera, renderer, geometry, material, plane, vShader, fShader;
...
function main() {
    ...
    loadShaders().then(() => {
        material = new THREE.ShaderMaterial({ vertexShader: vShader, fragmentShader: fShader });  // 应用顶点着色器和片元着色器
