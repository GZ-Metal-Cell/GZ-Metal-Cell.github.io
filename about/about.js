...
const strings = [
    ...
    ['你可以叫我`<b>`^250小^250 Z`</b>🤗`。^500我今年 `<b>`' + (new Date().getFullYear() - 1999).toString() + '</b> 岁了`🫣`。^1000我来自`<b>`^250福^250建^250省^250福^250州^250市`</b>😬`，^1000但是我并不会说福州话`😶`，^500也不喜欢吃海鲜 `😵`……^1000真是一个^250假^250福^250州^250人`😇`。^500',],
    ...
    ['游戏一直玩，^500学习成绩一直马马虎虎`🥱`。^1000本科就选择了有趣的`<b>`^250数^250字^250媒^250体^250技^250术`</b>`^250专业`😍`！^1000我喜欢用计算机创造各种有趣的事物`😎`！^1000额……^1000像写论文就不是有趣的事物`😒`。^500',],
    ...
    ['会游泳，^500会打羽毛球，^500还喜欢摄影，^500下象棋`🥸`。^1000额……^1000虽然都是业余水平`😳`……^1000曾经学过点素描，^500还是因为太懒就搁置了`🤐`。^500',],
    ['考研后阴差阳错地来到了`<b>`河北`</b>`上学`🤨`，^1000阴差阳错地选择了`<b>`人工智能`</b>`专业`🤫`，^1000成为了一名`<b>`^250科^250研^250废^250物`</b>😵`。^1000在这里体验到了不一样的生活`🤧`。^1000希望能在研究生的闲暇时光里多去看看祖国的大好河山`🥳`！^1000然后学点实在的东西。^500',
        '考研后阴差阳错地来到了<b>河北</b>上学🤨，阴差阳错地选择了<b>人工智能</b>专业🤫，成为了一名<b>科研废物</b>😵。在这里体验到了不一样的生活🤧。希望能在研究生的闲暇时光里多去看看祖国的大好河山🥳！^1000然后能够^250顺^250利^250毕^250业`😵‍💫`。^500',],
    ['尽管对一些人或事物仍存在遗憾`🫤`，^1000但……`<b>`^1000不^250以^250物^250喜^250，^250不^250以^250己^250悲`</b>`^250。^1000希望我能在以后的生活中成为^500更^250好^250的^250自^250己`🫡`！^500',]];
