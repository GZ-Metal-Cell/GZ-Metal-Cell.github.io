...
const strings = [
    ...
    ['你可以叫我`<b>`^250小^250 Z`</b>🤗`。^500我今年 `<b>`' + (new Date().getFullYear() - 1999).toString() + '</b> 岁了`🫣`。^1000我来自`<b>`^250福^250建^250省^250福^250州^250市`</b>😬`，^1000但我并不会说福州话`😶`，^500也不喜欢吃海鲜 `😵`……^1000真是一个^250假^250福^250州^250人`😇`。^500',],
