(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[9557],{
...
function createMermaidViewportController(options) {
    ...
    const computeHome = ()=>{
        ...
        homeY = vp.clientHeight / 2 - svgCenterY;
        return true;
    };
    const captureHome = ()=>{
...
function MermaidDiagramViewport({ children, className }) {
    ...
    react.useEffect(()=>{
        ...
        const obs = new MutationObserver(tryEstablishHome);
        obs.observe(viewport, {
            childList: true,
            subtree: true,
            attributes: true
        });
        const resizeObs = new ResizeObserver(tryEstablishHome);
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
        ...
        children: [
            /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
                ref: viewportRef,
                className: "mermaid-viewport relative min-h-[200px] max-h-[70vh] flex-1 overflow-hidden touch-none select-none cursor-grab [&.is-panning]:cursor-grabbing",
                role: "application",
...
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(95155);
/* harmony import */ var _contexts_PostAssetBaseContext__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(44272);
/* harmony import */ var _lib_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(40980);
 ...
 */ function Figure({ src, alt = '', children, caption }) {
    const resolvedSrc = (0,_contexts_PostAssetBaseContext__WEBPACK_IMPORTED_MODULE_1__/* .useResolvedPostAssetUrl */ .t9)(src);
    const content = resolvedSrc != null ? // eslint-disable-next-line @next/next/no-img-element
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("figure", {
        className: (0,_lib_utils__WEBPACK_IMPORTED_MODULE_2__.cn)('my-5 block w-full'),
...
function EChart({ option, src, title, height, theme, maps = EMPTY_MAPS, renderer = 'canvas' }) {
    ...
    const shellSignature = `${renderer}|${theme?.trim() ?? ''}|${siteMode}|${mapsKey}`;
...
/* harmony import */ var _lib_post_post_asset_url__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(58317);
...
function RawHtml({ html, photoFigcaptionEnabled = false }) {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        ...
        imgs.forEach((img)=>{
            ...
            if (!src) return;
            const resolvedSrc = postSlug ? (0,_lib_post_post_asset_url__WEBPACK_IMPORTED_MODULE_3__/* .resolvePostRelativeUrl */ .Au)(src, postSlug) : src;
...
function RevealDeck({ source, src, title, theme = 'auto', minHeight = '360px', navigationMode = 'default' }) {
    ...
    react.useEffect(()=>{
        ...
        async function initDeck() {
            ...
            if (themeModeRef.current !== themeMode) {
...
/* harmony import */ var _components_business_MdxContent__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(63449);
...
// EXTERNAL MODULE: ./src/components/mdx/RawHtml.tsx
var RawHtml = __webpack_require__(13143);
 ...
 */ function ImageGrid({ columns = 2, gap = 12, className, style, children }) {
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
        className: (0,_lib_utils__WEBPACK_IMPORTED_MODULE_3__.cn)("my-5 mx-auto grid", className),
        style: {
...
function ImageGridItem({ src, alt = "", children, className, aspect = "4/3", ...imgProps }) {
    ...
    if (children != null) {
        return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
            className: (0,_lib_utils__WEBPACK_IMPORTED_MODULE_3__.cn)("overflow-hidden rounded-md", // Apply aspect-ratio only when rendering native <img> children
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
        className: (0,_lib_utils__WEBPACK_IMPORTED_MODULE_3__.cn)("relative overflow-hidden rounded-md", className),
        style: {
            aspectRatio: aspect
        },
