"use strict";
(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[8520],{
...
function InnerPageLayoutContent({ showSidebar, sidebarContent, contentMaxWidth, noContentPadding, pageContentLabel, children }) {
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        className: `relative z-20 mx-auto max-w-[1400px] ${SECTION_OVERLAP} flex flex-col gap-6 pb-16 md:pb-20 lg:pb-24 lg:flex-row ${noContentPadding ? 'md:px-6 lg:px-24' : 'px-4 md:px-6 lg:px-24'}`,
        children: [
                ...
                children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_panel_list__WEBPACK_IMPORTED_MODULE_4__/* .PanelList */ .j3, {
                    children: items.map((item)=>{
                        ...
                        return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_panel_list__WEBPACK_IMPORTED_MODULE_4__/* .PanelItem */ .Kn, {
                            ...
                            liClassName: (0,_lib_utils__WEBPACK_IMPORTED_MODULE_7__.cn)('toc-item transition-[max-height,opacity,margin] duration-200 ease-out break-words', // Hidden rows use maxHeight:0; clip overflow so inner min-h does not inflate the scroll parent.
