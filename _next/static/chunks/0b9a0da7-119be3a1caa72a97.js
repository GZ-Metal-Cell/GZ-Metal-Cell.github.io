"use strict";
(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[2995],{
...
/* harmony export */ });
/* harmony import */ var _chunk_L5ZTLDWV_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(38033);
/* harmony import */ var _chunk_NZK2D7GU_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(17541);
/* harmony import */ var _chunk_O5CBEL6O_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(88774);
/* harmony import */ var _chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(32563);
/* harmony import */ var _chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(97096);
/* harmony import */ var _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(32165);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(18851);
...
var labelHelper = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(async (parent, node, _classes) => {
  let cssClasses;
  const useHtmlLabels = node.useHtmlLabels || (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .evaluate */ ._3)((0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)()?.htmlLabels);
  if (!_classes) {
  ...
  const labelEl = shapeSvg.insert("g").attr("class", "label").attr("style", (0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .KL)(node.labelStyle));
  let label;
  ...
  const text2 = await (0,_chunk_O5CBEL6O_mjs__WEBPACK_IMPORTED_MODULE_2__/* .createText */ .GZ)(
    labelEl,
    (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .sanitizeText */ .jZ)((0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .decodeEntities */ .Sm)(label), (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)()),
    {
      useHtmlLabels,
      width: node.width || (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)().flowchart?.wrappingWidth,
  ...
  if (useHtmlLabels) {
    ...
    await (0,_chunk_L5ZTLDWV_mjs__WEBPACK_IMPORTED_MODULE_0__/* .configureLabelImages */ .X)(div, label);
...
var insertLabel = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(async (parent, label, options) => {
  const useHtmlLabels = options.useHtmlLabels ?? (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getEffectiveHtmlLabels */ .E)((0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)());
  const labelEl = parent.insert("g").attr("class", "label").attr("style", options.labelStyle || "");
  const text2 = await (0,_chunk_O5CBEL6O_mjs__WEBPACK_IMPORTED_MODULE_2__/* .createText */ .GZ)(labelEl, (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .sanitizeText */ .jZ)((0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .decodeEntities */ .Sm)(label), (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)()), {
    useHtmlLabels,
    width: options.width || (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)()?.flowchart?.wrappingWidth,
    style: options.labelStyle,
    addSvgBackground: !!options.icon || !!options.img
  });
  let bbox = text2.getBBox();
  const halfPadding = options.padding / 2;
  if ((0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getEffectiveHtmlLabels */ .E)((0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)())) {
    const div = text2.children[0];
    const dv = (0,d3__WEBPACK_IMPORTED_MODULE_6__/* .select */ .Ltv)(text2);
    bbox = div.getBoundingClientRect();
    dv.attr("width", bbox.width);
...
function mergePaths(roughElement) {
  ...
  const getAttr = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)((element, attr) => {
...
(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(mergePaths, "mergePaths");
...
var createLabel = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(async (element, _vertexText, style, isTitle = false, isNode = false) => {
  ...
  const useHtmlLabels = (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getEffectiveHtmlLabels */ .E)(config);
  return await (0,_chunk_O5CBEL6O_mjs__WEBPACK_IMPORTED_MODULE_2__/* .createText */ .GZ)(
    element,
    vertexText,
    {
      style,
...
var rect = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(async (parent, node) => {
  ...
  const siteConfig = (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)();
  const { themeVariables, handDrawnSeed } = siteConfig;
  const { clusterBkg, clusterBorder } = themeVariables;
  const { labelStyles, nodeStyles, borderStyles, backgroundStyles } = (0,_chunk_NZK2D7GU_mjs__WEBPACK_IMPORTED_MODULE_1__/* .styles2String */ .GX)(node);
  const shapeSvg = parent.insert("g").attr("class", "cluster " + node.cssClasses).attr("id", node.domId).attr("data-look", node.look);
  const useHtmlLabels = (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getEffectiveHtmlLabels */ .E)(siteConfig);
  const labelEl = shapeSvg.insert("g").attr("class", "cluster-label ");
  let text2;
  if (node.labelType === "markdown") {
    text2 = await (0,_chunk_O5CBEL6O_mjs__WEBPACK_IMPORTED_MODULE_2__/* .createText */ .GZ)(labelEl, node.label, {
      style: node.labelStyle,
      useHtmlLabels,
      isNode: true,
      width: node.width
  ...
  let bbox = text2.getBBox();
  if ((0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getEffectiveHtmlLabels */ .E)(siteConfig)) {
    const div = text2.children[0];
    const dv = (0,d3__WEBPACK_IMPORTED_MODULE_6__/* .select */ .Ltv)(text2);
    bbox = div.getBoundingClientRect();
    dv.attr("width", bbox.width);
  ...
  if (node.look === "handDrawn") {
    ...
    const options = (0,_chunk_NZK2D7GU_mjs__WEBPACK_IMPORTED_MODULE_1__/* .userNodeOverrides */ .Fr)(node, {
      roughness: 0.7,
      fill: clusterBkg,
      // fill: 'red',
  ...
  const { subGraphTitleTopMargin } = (0,_chunk_L5ZTLDWV_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getSubGraphTitleMargins */ .O)(siteConfig);
  labelEl.attr(
    "transform",
...
var roundedWithTitle = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(async (parent, node) => {
  ...
  label.attr(
    "transform",
    `translate(${node.x - bbox.width / 2}, ${y + 1 - ((0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getEffectiveHtmlLabels */ .E)(siteConfig) ? 0 : 3)})`
  );
  const rectBox = rect2.node().getBBox();
  node.height = rectBox.height;
  node.offsetX = 0;
...
var kanbanSection = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(async (parent, node) => {
  ...
  const useHtmlLabels = (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getEffectiveHtmlLabels */ .E)(siteConfig);
  const labelEl = shapeSvg.insert("g").attr("class", "cluster-label ");
  const text2 = await (0,_chunk_O5CBEL6O_mjs__WEBPACK_IMPORTED_MODULE_2__/* .createText */ .GZ)(labelEl, node.label, {
    style: node.labelStyle,
    useHtmlLabels,
    isNode: true,
    width: node.width
...
function anchor(parent, node) {
  const { labelStyles } = (0,_chunk_NZK2D7GU_mjs__WEBPACK_IMPORTED_MODULE_1__/* .styles2String */ .GX)(node);
  ...
  const rc = roughjs__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A.svg(shapeSvg);
  const options = (0,_chunk_NZK2D7GU_mjs__WEBPACK_IMPORTED_MODULE_1__/* .userNodeOverrides */ .Fr)(node, { fill: "black", stroke: "none", fillStyle: "solid" });
  if (node.look !== "handDrawn") {
    options.roughness = 0;
  }
  const roughNode = rc.circle(0, 0, radius * 2, options);
  const circleElem = shapeSvg.insert(() => roughNode, ":first-child");
  circleElem.attr("class", "anchor").attr("style", (0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .KL)(cssStyles));
...
(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(calculateArcSagitta, "calculateArcSagitta");
async function bowTieRect(parent, node) {
  const { labelStyles, nodeStyles } = (0,_chunk_NZK2D7GU_mjs__WEBPACK_IMPORTED_MODULE_1__/* .styles2String */ .GX)(node);
  node.labelStyle = labelStyles;
  const nodePadding = node.padding ?? 0;
  const labelPaddingX = node.look === "neo" ? 16 : nodePadding;
  const labelPaddingY = node.look === "neo" ? 12 : nodePadding;
  const calcTotalHeight = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)((labelHeight) => labelHeight + labelPaddingY, "calcTotalHeight");
  const calcEllipseRadius = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)((totalHeight2) => {
...
function choice(parent, node) {
  const { nodeStyles } = (0,_chunk_NZK2D7GU_mjs__WEBPACK_IMPORTED_MODULE_1__/* .styles2String */ .GX)(node);
  node.label = "";
...
async function circle(parent, node, options) {
  ...
  if (node.look === "handDrawn") {
    const rc = roughjs__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A.svg(shapeSvg);
    const options2 = (0,_chunk_NZK2D7GU_mjs__WEBPACK_IMPORTED_MODULE_1__/* .userNodeOverrides */ .Fr)(node, {});
    const roughNode = rc.circle(0, 0, radius * 2, options2);
    circleElem = shapeSvg.insert(() => roughNode, ":first-child");
    circleElem.attr("class", "basic label-container").attr("style", (0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .KL)(cssStyles));
  } else {
...
async function curlyBraceLeft(parent, node) {
  ...
  const rc = roughjs__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A.svg(shapeSvg);
  const options = (0,_chunk_NZK2D7GU_mjs__WEBPACK_IMPORTED_MODULE_1__/* .userNodeOverrides */ .Fr)(node, { fill: "none" });
  if (node.look !== "handDrawn") {
    options.roughness = 0;
    options.fillStyle = "solid";
  }
...
async function cylinder(parent, node) {
  ...
  if (node.look === "handDrawn") {
    ...
    const innerLine = rc.path(innerPathData, (0,_chunk_NZK2D7GU_mjs__WEBPACK_IMPORTED_MODULE_1__/* .userNodeOverrides */ .Fr)(node, { fill: "none" }));
    ...
    cylinder2 = shapeSvg.insert("path", ":first-child").attr("d", pathData).attr("class", "basic label-container outer-path").attr("style", (0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .KL)(cssStyles)).attr("style", nodeStyles);
  }
...
async function drawRect(parent, node, options) {
  ...
  if (node.look === "handDrawn") {
    ...
    rect2.attr("class", "basic label-container").attr("style", (0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .KL)(cssStyles));
  } else {
    rect2 = shapeSvg.insert("rect", ":first-child");
    rect2.attr("class", "basic label-container").attr("style", nodeStyles).attr("rx", (0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .KL)(rx)).attr("ry", (0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .KL)(ry)).attr("x", x).attr("y", y).attr("width", totalWidth).attr("height", totalHeight);
  }
...
async function datastore(parent, node) {
  ...
  if (node.look === "handDrawn") {
    const rc = roughjs__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A.svg(rect2);
    const nodeOverrideOptions = (0,_chunk_NZK2D7GU_mjs__WEBPACK_IMPORTED_MODULE_1__/* .userNodeOverrides */ .Fr)(node, {});
...
(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(datastore, "datastore");
...
async function doublecircle(parent, node) {
  ...
  if (node.look === "handDrawn") {
    const rc = roughjs__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A.svg(shapeSvg);
    const outerOptions = (0,_chunk_NZK2D7GU_mjs__WEBPACK_IMPORTED_MODULE_1__/* .userNodeOverrides */ .Fr)(node, { roughness: 0.2, strokeWidth: 2.5 });
    const innerOptions = (0,_chunk_NZK2D7GU_mjs__WEBPACK_IMPORTED_MODULE_1__/* .userNodeOverrides */ .Fr)(node, { roughness: 0.2, strokeWidth: 1.5 });
    const outerRoughNode = rc.circle(0, 0, outerRadius * 2, outerOptions);
    const innerRoughNode = rc.circle(0, 0, innerRadius * 2, innerOptions);
    circleGroup = shapeSvg.insert("g", ":first-child");
    circleGroup.attr("class", (0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .KL)(node.cssClasses)).attr("style", (0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .KL)(cssStyles));
...
function filledCircle(parent, node, { config: { themeVariables } }) {
  ...
  const rc = roughjs__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A.svg(shapeSvg);
  const { nodeBorder } = themeVariables;
  const options = (0,_chunk_NZK2D7GU_mjs__WEBPACK_IMPORTED_MODULE_1__/* .userNodeOverrides */ .Fr)(node, { fillStyle: "solid" });
  if (node.look !== "handDrawn") {
    options.roughness = 0;
  }
  const circleNode = rc.circle(0, 0, radius * 2, options);
...
async function icon(parent, node, { config: { themeVariables, flowchart } }) {
  ...
  const { nodeBorder } = themeVariables;
  const { stylesMap } = (0,_chunk_NZK2D7GU_mjs__WEBPACK_IMPORTED_MODULE_1__/* .compileStyles */ .WW)(node);
  const x = -width / 2;
  const y = -height / 2;
  const labelPadding = node.label ? 8 : 0;
  const rc = roughjs__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A.svg(shapeSvg);
  const options = (0,_chunk_NZK2D7GU_mjs__WEBPACK_IMPORTED_MODULE_1__/* .userNodeOverrides */ .Fr)(node, { stroke: "none", fill: "none" });
  if (node.look !== "handDrawn") {
    options.roughness = 0;
    options.fillStyle = "solid";
  }
  ...
  if (node.icon) {
    ...
    iconElem.html(
      `<g>${await (0,_chunk_O5CBEL6O_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getIconSVG */ .WY)(node.icon, {
        height: iconSize,
        width: iconSize,
        fallbackPrefix: ""
      })}</g>`
...
async function note(parent, node, { config: { themeVariables } }) {
  const { labelStyles, nodeStyles } = (0,_chunk_NZK2D7GU_mjs__WEBPACK_IMPORTED_MODULE_1__/* .styles2String */ .GX)(node);
  node.labelStyle = labelStyles;
  const useHtmlLabels = node.useHtmlLabels || (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getEffectiveHtmlLabels */ .E)((0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig */ .zj)());
  if (!useHtmlLabels) {
...
async function shadedProcess(parent, node) {
  ...
  rect2.attr("class", "basic label-container outer-path").attr("style", (0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .KL)(cssStyles));
  if (nodeStyles && node.look !== "handDrawn") {
    rect2.selectAll("path").attr("style", nodeStyles);
  }
  if (cssStyles && node.look !== "handDrawn") {
...
function stateStart(parent, node, { config: { themeVariables } }) {
  ...
  if (node.look === "handDrawn") {
    const rc = roughjs__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A.svg(shapeSvg);
    const roughNode = rc.circle(0, 0, node.width, (0,_chunk_NZK2D7GU_mjs__WEBPACK_IMPORTED_MODULE_1__/* .solidStateFill */ .ue)(lineColor));
...
async function tiltedCylinder(parent, node) {
  ...
  if (node.look === "handDrawn") {
    ...
    const outerNode = rc.path(outerPathData, (0,_chunk_NZK2D7GU_mjs__WEBPACK_IMPORTED_MODULE_1__/* .userNodeOverrides */ .Fr)(node, {}));
    const innerLine = rc.path(innerPathData, (0,_chunk_NZK2D7GU_mjs__WEBPACK_IMPORTED_MODULE_1__/* .userNodeOverrides */ .Fr)(node, { fill: "none" }));
    cylinder2 = shapeSvg.insert(() => innerLine, ":first-child");
    cylinder2 = shapeSvg.insert(() => outerNode, ":first-child");
    cylinder2.attr("class", "basic label-container");
    ...
    cylinder2 = shapeSvg.insert("path", ":first-child").attr("d", pathData).attr("class", "basic label-container").attr("style", (0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .KL)(cssStyles)).attr("style", nodeStyles);
...
async function triangle(parent, node) {
  ...
  const { shapeSvg, bbox, label } = await labelHelper(parent, node, getNodeClasses(node));
  const useHtmlLabels = (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .evaluate */ ._3)((0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)().flowchart?.htmlLabels);
...
async function erBox(parent, node) {
  ...
  const { theme, themeVariables } = (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig */ .zj)();
  const { rowEven, rowOdd, nodeBorder, borderColorArray } = themeVariables;
  if (node.look === "handDrawn") {
    const { themeVariables: themeVariables2 } = (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig */ .zj)();
  ...
  const config = (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig */ .zj)();
  ...
  if (entityNode.attributes.length === 0 && node.label) {
    ...
    if ((0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .calculateTextWidth */ .Un)(node.label, config) + options2.labelPaddingX * 2 < config.er.minEntityWidth) {
    ...
    if (!(0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .evaluate */ ._3)(config.htmlLabels)) {
...
async function addText(shapeSvg, labelText, config, translateX = 0, translateY = 0, classes = [], style = "") {
  ...
  if (labelText !== (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .parseGenericTypes */ .QO)(labelText)) {
    labelText = (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .parseGenericTypes */ .QO)(labelText);
    labelText = labelText.replaceAll("<", "&lt;").replaceAll(">", "&gt;");
  }
  const text2 = label.node().appendChild(
    await (0,_chunk_O5CBEL6O_mjs__WEBPACK_IMPORTED_MODULE_2__/* .createText */ .GZ)(
      label,
      labelText,
      {
        width: (0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .calculateTextWidth */ .Un)(labelText, config) + 100,
        style,
...
(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(lineToPolygon, "lineToPolygon");
...
async function addText2(parentGroup, node, yOffset, styles = []) {
  ...
  const config = (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig */ .zj)();
  let useHtmlLabels = "useHtmlLabels" in node ? node.useHtmlLabels : (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .evaluate */ ._3)(config.htmlLabels) ?? true;
  let textContent = "";
  if ("text" in node) {
  ...
  if ((0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .hasKatex */ .Wi)(textContent)) {
    useHtmlLabels = true;
  }
  const text2 = await (0,_chunk_O5CBEL6O_mjs__WEBPACK_IMPORTED_MODULE_2__/* .createText */ .GZ)(
    textEl,
    (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .sanitizeText2 */ .oB)((0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .decodeEntities */ .Sm)(textContent)),
    {
      width: (0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .calculateTextWidth */ .Un)(textContent, config) + 50,
...
async function classBox(parent, node) {
  ...
  const GAP = PADDING;
  const useHtmlLabels = node.useHtmlLabels ?? (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .evaluate */ ._3)(config.htmlLabels) ?? true;
...
async function requirementBox(parent, node) {
  ...
  const classes = getNodeClasses(node);
  const { themeVariables } = (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)();
...
async function addText3(parentGroup, inputText, yOffset, style = "") {
  ...
  const text2 = await (0,_chunk_O5CBEL6O_mjs__WEBPACK_IMPORTED_MODULE_2__/* .createText */ .GZ)(
    textEl,
    (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .sanitizeText2 */ .oB)((0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .decodeEntities */ .Sm)(inputText)),
    {
      width: (0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .calculateTextWidth */ .Un)(inputText, config) + 50,
      // Add room for error when splitting text into multiple lines
      classes: "markdown-node-label",
      useHtmlLabels,
      style
...
async function kanbanItem(parent, kanbanNode, { config }) {
  const { labelStyles, nodeStyles } = (0,_chunk_NZK2D7GU_mjs__WEBPACK_IMPORTED_MODULE_1__/* .styles2String */ .GX)(kanbanNode);
  ...
  if (kanbanNode.look === "handDrawn") {
    const rc = roughjs__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A.svg(shapeSvg);
    const options2 = (0,_chunk_NZK2D7GU_mjs__WEBPACK_IMPORTED_MODULE_1__/* .userNodeOverrides */ .Fr)(kanbanNode, {});
    const roughNode = rx || ry ? rc.path(createRoundedRectPathD(x, y, totalWidth, totalHeight, rx || 0), options2) : rc.rectangle(x, y, totalWidth, totalHeight, options2);
    rect2 = shapeSvg.insert(() => roughNode, ":first-child");
...
async function bang(parent, node) {
  ...
  if (node.look === "handDrawn") {
    ...
    bangElem.attr("class", "basic label-container").attr("style", (0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .KL)(cssStyles));
  } else {
...
async function cloud(parent, node) {
  ...
  if (node.look === "handDrawn") {
    ...
    cloudElem.attr("class", "basic label-container").attr("style", (0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .KL)(cssStyles));
  } else {
...
async function insertNode(elem, node, renderOptions) {
  ...
  newEl.attr("data-look", (0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .KL)(node.look));
  if (node.tooltip) {
