...
function InnerPageLayoutContent({ showSidebar, sidebarContent, contentMaxWidth, noContentPadding, pageContentLabel, children }) {
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        "data-inner-page-content": true,
        className: `relative z-20 mx-auto max-w-350 ${SECTION_OVERLAP} flex flex-col gap-6 pb-16 md:pb-20 lg:pb-24 lg:flex-row ${noContentPadding ? 'md:px-6 lg:px-20' : 'px-4 md:px-6 lg:px-20'}`,
        children: [
            ...
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("section", {
                ...
                className: contentMaxWidth ? `order-1 lg:order-2 min-w-0 w-full md:mx-auto md:max-w-245 ${sidebarVisible ? 'lg:w-[78%]' : ''}` : sidebarVisible ? `order-1 lg:order-2 min-w-0 lg:w-[78%] w-full` : 'w-full',
