                    ...
                    children: [
                        /*#__PURE__*/ (0,jsx_runtime.jsx)(BreadcrumbItem, {
                            ...
                            children: seg.href != null || isLast ? /*#__PURE__*/ (0,jsx_runtime.jsx)(BreadcrumbLink, {
                                ...
                                className: (0,utils.cn)('px-4', seg.muted ? 'text-muted-foreground' : currentBreadcrumbClass),
                                children: seg.label
                            })
                        }),
...
function FloatingActionBar() {
    ...
    const mounted = (0,react__WEBPACK_IMPORTED_MODULE_2__.useSyncExternalStore)(subscribeToNothing, ()=>true, ()=>false);
    ...
    /** Ref to cancel an ongoing scroll-to-bottom polling loop. */ const cancelScrollRef = (0,react__WEBPACK_IMPORTED_MODULE_2__.useRef)(null);
    const cancelAutoScroll = (0,react__WEBPACK_IMPORTED_MODULE_2__.useCallback)(()=>{
    ...
    const handleToggleSidebar = (0,react__WEBPACK_IMPORTED_MODULE_2__.useCallback)(()=>{
        cancelAutoScroll();
        toggleSidebar();
    }, [
        cancelAutoScroll,
    ...
    const scrollToBottom = ()=>{
        // Cancel any previous auto-scroll still in flight
        cancelAutoScroll();
        let cancelled = false;
        // Detect user interaction via wheel/touchmove/click instead of scroll events,
        // because our own smooth scrollTo() also fires scroll events and would
        // incorrectly cancel the polling.
        const cancel = ()=>{
            cancelled = true;
        };
        ...
        // Also cancel when the user clicks anywhere (links, buttons, etc.)
        ...
        const POLL_MS = 200;
        const MAX_UNCHANGED_TICKS = 25 // 5 seconds
        ;
        const poll = ()=>{
            if (cancelled) {
                cleanup();
            ...
            // Stop immediately once we've reached the bottom (2 px tolerance
            // for subpixel rounding).  This also handles the case where the
            // page is already at the bottom when the button is first clicked.
        ...
        // Scroll immediately on first call
        const h = document.documentElement.scrollHeight;
        lastHeight = h;
        window.scrollTo({
            top: h,
...
/******/ __webpack_require__.O(0, [4785,4153,2362,9589,458,1989,6714,1716,4701,8441,3794,7358], () => (__webpack_exec__(8464)));
