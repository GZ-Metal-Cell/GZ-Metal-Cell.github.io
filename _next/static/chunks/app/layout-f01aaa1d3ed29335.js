...
const BreadcrumbList = /*#__PURE__*/ react.forwardRef(({ className, ...props }, ref)=>/*#__PURE__*/ (0,jsx_runtime.jsx)("ol", {
        ref: ref,
        className: (0,classnames.cn)("flex flex-wrap items-center wrap-break-word text-sm text-muted-foreground", className),
        ...props
    }));
BreadcrumbList.displayName = "BreadcrumbList";
const BreadcrumbItem = /*#__PURE__*/ react.forwardRef(({ className, ...props }, ref)=>/*#__PURE__*/ (0,jsx_runtime.jsx)("li", {
        ref: ref,
        className: (0,classnames.cn)("inline-flex items-center", className),
        ...props
    }));
BreadcrumbItem.displayName = "BreadcrumbItem";
const BreadcrumbLink = /*#__PURE__*/ react.forwardRef(({ asChild, className, ...props }, ref)=>{
    if (asChild) {
        // asChild mode: render Slot, child provides its own href (e.g. <HeaderNavLink href={...}>)
        return /*#__PURE__*/ (0,jsx_runtime.jsx)(dist/* Slot */.DX, {
            ref: ref,
            className: (0,classnames.cn)('transition-colors hover:text-foreground', className),
            ...props
        });
    }
    // Direct mode: render Next.js Link for client-side navigation
...
const BreadcrumbPage = /*#__PURE__*/ react.forwardRef(({ className, ...props }, ref)=>/*#__PURE__*/ (0,jsx_runtime.jsx)("span", {
        ...
        "aria-disabled": "true",
        "aria-current": "page",
        className: (0,classnames.cn)("font-normal text-foreground", className),
        ...props
    }));
...
const BreadcrumbSeparator = ({ children, className, ...props })=>/*#__PURE__*/ (0,jsx_runtime.jsx)("li", {
        role: "presentation",
        "aria-hidden": "true",
        className: (0,classnames.cn)("[&>svg]:w-3.5 [&>svg]:h-3.5", className),
        ...props,
...
const BreadcrumbEllipsis = ({ className, ...props })=>/*#__PURE__*/ (0,jsx_runtime.jsxs)("span", {
        role: "presentation",
        "aria-hidden": "true",
        className: (0,classnames.cn)("flex h-9 w-9 items-center justify-center", className),
        ...props,
        children: [
 ...
 */ const HeaderNavLink = /*#__PURE__*/ react.forwardRef(({ isActive, className, children, ...props }, ref)=>/*#__PURE__*/ (0,jsx_runtime.jsx)((link_default()), {
        ref: ref,
        className: (0,classnames.cn)(headerNavLinkBase, isActive ? headerNavLinkActive : headerNavLinkInactive, className),
        ...props,
        children: children
    }));
...
function buildPostBreadcrumbSegments(slug, data, tNav, tCommon) {
    ...
    const full = (0,app_path/* normalizePostSlugKey */.C2)(slug);
    const category = data.postSlugToCategory[full] ?? data.postSlugToCategory[(0,app_path/* normalizePostSlugKey */.C2)(parentSlug)] ?? data.defaultCategory;
    segments.push({
        label: category,
        href: (0,app_path/* internalHref */.dI)(`/categories/${encodeURIComponent(category)}`)
    });
...
/** Unified breadcrumb: content mode (segments/label for slot) or banner mode (breadcrumbSlot + navItems) */ function Breadcrumb_Breadcrumb(props) {
    ...
    if (isContentMode && segments) {
        ...
        react.useEffect(()=>{
            ...
            if (!el) return;
            const check = ()=>setCollapsed(el.scrollWidth > el.clientWidth);
            check();
        ...
        const displaySegments = collapsed && segments.length > 2 ? [
            {
                label: '…',
                muted: true
            },
        ...
        const renderSegmentItems = (segs)=>segs.map((seg, i)=>{
                    ...
                    children: [
                        /*#__PURE__*/ (0,jsx_runtime.jsx)(BreadcrumbItem, {
                            ...
                            children: seg.href != null || isLast ? /*#__PURE__*/ (0,jsx_runtime.jsx)(BreadcrumbLink, {
                                ...
                                className: (0,classnames.cn)('px-4', seg.muted ? 'text-muted-foreground' : currentBreadcrumbClass),
                                children: seg.label
                            })
                        }),
        ...
        const list = /*#__PURE__*/ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
            children: [
                /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
                    ref: measureRef,
                    "aria-hidden": "true",
                    className: "absolute invisible overflow-hidden whitespace-nowrap left-0 right-0",
                    style: {
                        height: 0
                    },
                    children: /*#__PURE__*/ (0,jsx_runtime.jsx)(BreadcrumbList, {
                        className: "h-full flex-nowrap",
                        children: renderSegmentItems(segments)
                    })
                }),
                /*#__PURE__*/ (0,jsx_runtime.jsx)(BreadcrumbList, {
                    className: "h-full flex-nowrap overflow-hidden",
                    children: renderSegmentItems(displaySegments)
                })
            ]
        });
        if (!wrapInNav) {
...
/** Breadcrumb generated from pathname + enum-based pattern matching. No parallel routes. */ function PathBasedBreadcrumb({ data }) {
    ...
    const tNav = (0,react_client/* useTranslations */.c)('nav');
    const tCommon = (0,react_client/* useTranslations */.c)('common');
    let pattern = getPathPattern(pathname);
    // For POST pattern, validate that the post slug actually exists
    if (pattern === PathPattern.POST) {
        const slug = slugFromPostPath(pathname);
        if (slug && !((0,app_path/* normalizePostSlugKey */.C2)(slug) in data.postSlugToCategory)) {
            pattern = PathPattern.UNKNOWN;
        }
    }
    const segments = buildPathBasedSegments(pathname, pattern, data, (k)=>tNav(k), (k)=>tCommon(k));
    if (segments.length === 0) {
        if (pattern === PathPattern.UNKNOWN && pathname !== '/' && pathname !== '') {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
        children: [
            /*#__PURE__*/ (0,jsx_runtime.jsx)("script", {
                id: "banner-breadcrumb-segments",
                type: "application/json",
                dangerouslySetInnerHTML: {
                    __html: JSON.stringify(segments)
                }
            }),
            /*#__PURE__*/ (0,jsx_runtime.jsx)(Breadcrumb_Breadcrumb, {
                segments: segments,
                wrapInNav: false
            })
        ]
...
/** Left part of Banner: logo + breadcrumb */ function HeaderBreadcrumb({ navItems, menuTitles, breadcrumbSlot }) {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
                className: "hidden md:block h-full min-w-0 overflow-hidden",
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)("button", {
                ...
                className: "flex md:hidden h-full items-center justify-center px-4 font-medium transition-colors focus-visible:outline-hidden focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-muted hover:text-highlight text-foreground",
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
        children: [
            /*#__PURE__*/ (0,jsx_runtime.jsx)("button", {
                ...
                className: (0,classnames.cn)('md:hidden fixed inset-0 z-210 bg-black/50 transition-opacity duration-200 ease-out', mobileMenuOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'),
                ...
                children: [
                    /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
                                className: "flex h-full items-stretch justify-end gap-3",
                    ...
                    /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
                        className: (0,classnames.cn)('md:hidden absolute top-16 left-0 right-0 border-t border-border bg-background/95 backdrop-blur-md overflow-hidden transition-[max-height,opacity,transform] duration-200 ease-out shadow-lg', mobileMenuOpen ? 'max-h-80 opacity-100 translate-y-0' : 'max-h-0 opacity-0 -translate-y-2 pointer-events-none'),
                        "aria-hidden": !mobileMenuOpen,
...
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(95155);
/* harmony import */ var _barrel_optimize_names_ArrowDown_ArrowUp_BookOpen_Check_Copy_LogOut_Moon_PanelLeft_PanelLeftClose_Sun_Wrench_lucide_react__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(94514);
/* harmony import */ var _barrel_optimize_names_ArrowDown_ArrowUp_BookOpen_Check_Copy_LogOut_Moon_PanelLeft_PanelLeftClose_Sun_Wrench_lucide_react__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(67635);
/* harmony import */ var _barrel_optimize_names_ArrowDown_ArrowUp_BookOpen_Check_Copy_LogOut_Moon_PanelLeft_PanelLeftClose_Sun_Wrench_lucide_react__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(97810);
/* harmony import */ var _barrel_optimize_names_ArrowDown_ArrowUp_BookOpen_Check_Copy_LogOut_Moon_PanelLeft_PanelLeftClose_Sun_Wrench_lucide_react__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(51900);
/* harmony import */ var _barrel_optimize_names_ArrowDown_ArrowUp_BookOpen_Check_Copy_LogOut_Moon_PanelLeft_PanelLeftClose_Sun_Wrench_lucide_react__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(36999);
/* harmony import */ var _barrel_optimize_names_ArrowDown_ArrowUp_BookOpen_Check_Copy_LogOut_Moon_PanelLeft_PanelLeftClose_Sun_Wrench_lucide_react__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(90329);
/* harmony import */ var _barrel_optimize_names_ArrowDown_ArrowUp_BookOpen_Check_Copy_LogOut_Moon_PanelLeft_PanelLeftClose_Sun_Wrench_lucide_react__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(6071);
/* harmony import */ var _barrel_optimize_names_ArrowDown_ArrowUp_BookOpen_Check_Copy_LogOut_Moon_PanelLeft_PanelLeftClose_Sun_Wrench_lucide_react__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(41313);
/* harmony import */ var _barrel_optimize_names_ArrowDown_ArrowUp_BookOpen_Check_Copy_LogOut_Moon_PanelLeft_PanelLeftClose_Sun_Wrench_lucide_react__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(72055);
/* harmony import */ var _barrel_optimize_names_ArrowDown_ArrowUp_BookOpen_Check_Copy_LogOut_Moon_PanelLeft_PanelLeftClose_Sun_Wrench_lucide_react__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(56842);
/* harmony import */ var _barrel_optimize_names_ArrowDown_ArrowUp_BookOpen_Check_Copy_LogOut_Moon_PanelLeft_PanelLeftClose_Sun_Wrench_lucide_react__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(32967);
...
/* harmony import */ var _contexts_SidebarVisibilityContext__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5103);
/* harmony import */ var _contexts_ReadingModeContext__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(37444);
...
const paginationButtonClass = 'size-8 rounded-lg border border-border bg-background shadow-card hover:bg-muted hover:text-foreground';
const toolButtonClass = 'size-8 rounded-lg border border-border bg-background shadow-card hover:bg-muted hover:text-foreground transition-transform duration-200';
/** Tailwind lg breakpoint (min-width) in px; sidebar is visible only at lg and up */ const LG_MIN_WIDTH_PX = 1024;
/** Hydration-safe mounted detection (same pattern as ThemeSwitch). */ function subscribeToNothing() {
    return ()=>{};
}
function FloatingActionBar() {
    const { hasSidebar, collapsed, toggleSidebar } = (0,_contexts_SidebarVisibilityContext__WEBPACK_IMPORTED_MODULE_4__/* .useSidebarVisibility */ .i)();
    const { readingMode, toggleReadingMode } = (0,_contexts_ReadingModeContext__WEBPACK_IMPORTED_MODULE_5__/* .useReadingMode */ .J)();
    const [isLgViewport, setIsLgViewport] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)(false);
    const [popupOpen, setPopupOpen] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)(false);
    const [copyFeedback, setCopyFeedback] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)('idle');
    const popupRef = (0,react__WEBPACK_IMPORTED_MODULE_3__.useRef)(null);
    const toolsBtnRef = (0,react__WEBPACK_IMPORTED_MODULE_3__.useRef)(null);
    const pathname = (0,next_navigation__WEBPACK_IMPORTED_MODULE_2__.usePathname)();
    // Detect if #post-content exists (post pages + source pages)
    const [hasPostContent, setHasPostContent] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)(false);
    // Detect if post is fully encrypted (password in frontmatter)
    const [isEncrypted, setIsEncrypted] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)(false);
    // Read per-post / config flags from data attributes on #post-content.
    // Default to false — only posts and source pages set these attributes explicitly.
    const [copySourceEnabled, setCopySourceEnabled] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)(false);
    const [readingModeEnabled, setReadingModeEnabled] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)(false);
    (0,react__WEBPACK_IMPORTED_MODULE_3__.useEffect)(()=>{
        const timer = requestAnimationFrame(()=>{
            const article = document.getElementById('post-content');
            setHasPostContent(article !== null);
            setIsEncrypted(article?.getAttribute('data-encrypted') === 'true');
            setCopySourceEnabled(article?.getAttribute('data-copy-source-enabled') === 'true');
            setReadingModeEnabled(article?.getAttribute('data-reading-mode-enabled') === 'true');
        });
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_3__.useEffect)(()=>{
        ...
        const handleClickOutside = (e)=>{
            if (popupRef.current && !popupRef.current.contains(e.target) && toolsBtnRef.current && !toolsBtnRef.current.contains(e.target)) {
                setPopupOpen(false);
            }
        };
    ...
    // Clear copy feedback after a delay
    (0,react__WEBPACK_IMPORTED_MODULE_3__.useEffect)(()=>{
    ...
    const mounted = (0,react__WEBPACK_IMPORTED_MODULE_3__.useSyncExternalStore)(subscribeToNothing, ()=>true, ()=>false);
    const t = (0,next_intl__WEBPACK_IMPORTED_MODULE_7__/* .useTranslations */ .c)('floatingBar');
    const otherTheme = resolvedTheme === 'dark' ? 'light' : 'dark';
    const themeButtonLabel = mounted ? t('switchTheme', {
        theme: otherTheme
    }) : t('toggleTheme');
    /** Ref to cancel an ongoing scroll-to-bottom polling loop. */ const cancelScrollRef = (0,react__WEBPACK_IMPORTED_MODULE_3__.useRef)(null);
    const cancelAutoScroll = (0,react__WEBPACK_IMPORTED_MODULE_3__.useCallback)(()=>{
        cancelScrollRef.current?.();
        cancelScrollRef.current = null;
    }, []);
    const handleToolsClick = (0,react__WEBPACK_IMPORTED_MODULE_3__.useCallback)(()=>{
        cancelAutoScroll();
        setPopupOpen((prev)=>!prev);
    }, [
        cancelAutoScroll
    ]);
    const handleThemeClick = (0,react__WEBPACK_IMPORTED_MODULE_3__.useCallback)((e)=>{
        e.preventDefault();
        e.stopPropagation();
        cancelAutoScroll();
        // Keep popup open
        (0,react__WEBPACK_IMPORTED_MODULE_3__.startTransition)(()=>setTheme(otherTheme));
    }, [
        cancelAutoScroll,
        setTheme,
        otherTheme
    ]);
    const handleToggleSidebar = (0,react__WEBPACK_IMPORTED_MODULE_3__.useCallback)(()=>{
        cancelAutoScroll();
        // Keep popup open
        toggleSidebar();
    }, [
    ...
    const handleToggleReadingMode = (0,react__WEBPACK_IMPORTED_MODULE_3__.useCallback)(()=>{
        cancelAutoScroll();
        // Keep popup open
        toggleReadingMode();
    }, [
    ...
    const handleCopySource = (0,react__WEBPACK_IMPORTED_MODULE_3__.useCallback)(async ()=>{
        cancelAutoScroll();
        try {
            let url;
            if (pathname.startsWith('/posts/')) {
                // pathname may be URL-encoded by the browser; decode first to avoid double-encoding
                const rawSlug = pathname.replace(/^\/posts\//, '').replace(/\/$/, '');
                const slug = decodeURIComponent(rawSlug);
                url = `/copy-text/_posts/${encodeURIComponent(slug)}.txt`;
            } else {
                // Source page: extract folder from pathname (e.g. /links/ → links)
                const rawFolder = pathname.replace(/^\//, '').replace(/\/$/, '');
                const folder = decodeURIComponent(rawFolder);
                url = `/copy-text/${encodeURIComponent(folder)}.txt`;
            }
    ...
    const scrollToTop = ()=>{
        cancelAutoScroll();
        const target = readingMode ? document.getElementById('post-content') : null;
        if (target) {
            target.scrollTo({
                top: 0,
                behavior: 'smooth'
    ...
    const scrollToBottom = ()=>{
        ...
        const getScrollContainer = ()=>readingMode ? document.getElementById('post-content') : null;
        const scrollTarget = getScrollContainer();
        let lastHeight = 0;
        let unchangedTicks = 0;
        const POLL_MS = 200;
        const MAX_UNCHANGED_TICKS = 25;
        const poll = ()=>{
            if (cancelled) {
                cleanup();
                return;
    ...
    const toolButtons = [];
    // Copy source: only on content pages that are NOT fully encrypted AND copy is enabled
    if (hasPostContent && !isEncrypted && copySourceEnabled) {
        toolButtons.push({
            key: 'copy',
            button: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("li", {
                children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_button__WEBPACK_IMPORTED_MODULE_6__/* .Button */ .$, {
                    type: "button",
                    variant: "ghost",
                    size: "icon",
                    title: copyFeedback === 'success' ? t('copySuccess') : copyFeedback === 'error' ? t('copyFailed') : t('copySource'),
                    "aria-label": t('copySource'),
                    onClick: handleCopySource,
                    className: toolButtonClass,
                    children: copyFeedback === 'success' ? /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_barrel_optimize_names_ArrowDown_ArrowUp_BookOpen_Check_Copy_LogOut_Moon_PanelLeft_PanelLeftClose_Sun_Wrench_lucide_react__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .A, {
                        className: "size-4",
                        "aria-hidden": true
                    }) : /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_barrel_optimize_names_ArrowDown_ArrowUp_BookOpen_Check_Copy_LogOut_Moon_PanelLeft_PanelLeftClose_Sun_Wrench_lucide_react__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .A, {
                        className: "size-4",
                        "aria-hidden": true
                    })
                })
    ...
    // Reading mode: any page with #post-content AND reading mode is enabled
    if (hasPostContent && readingModeEnabled) {
        toolButtons.push({
            key: 'reading',
            button: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("li", {
                children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_button__WEBPACK_IMPORTED_MODULE_6__/* .Button */ .$, {
                    ...
                    className: toolButtonClass,
                    children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_barrel_optimize_names_ArrowDown_ArrowUp_BookOpen_Check_Copy_LogOut_Moon_PanelLeft_PanelLeftClose_Sun_Wrench_lucide_react__WEBPACK_IMPORTED_MODULE_10__/* ["default"] */ .A, {
                        className: `size-4 ${readingMode ? 'text-(--color-highlight)' : ''}`,
                        "aria-hidden": true
                    })
                })
            }, "reading")
    ...
    toolButtons.push({
        key: 'theme',
        button: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("li", {
            children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components_ui_button__WEBPACK_IMPORTED_MODULE_6__/* .Button */ .$, {
                type: "button",
                variant: "ghost",
                size: "icon",
                ...
                className: toolButtonClass,
                children: [
                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_barrel_optimize_names_ArrowDown_ArrowUp_BookOpen_Check_Copy_LogOut_Moon_PanelLeft_PanelLeftClose_Sun_Wrench_lucide_react__WEBPACK_IMPORTED_MODULE_11__/* ["default"] */ .A, {
                        className: "size-4 dark:hidden",
                        "aria-hidden": true
                    }),
                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_barrel_optimize_names_ArrowDown_ArrowUp_BookOpen_Check_Copy_LogOut_Moon_PanelLeft_PanelLeftClose_Sun_Wrench_lucide_react__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .A, {
    ...
    // Sidebar toggle: lg+ viewport only
        ...
        toolButtons.push({
            ...
            button: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("li", {
                children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_button__WEBPACK_IMPORTED_MODULE_6__/* .Button */ .$, {
                    ...
                    className: toolButtonClass,
                    children: collapsed ? /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_barrel_optimize_names_ArrowDown_ArrowUp_BookOpen_Check_Copy_LogOut_Moon_PanelLeft_PanelLeftClose_Sun_Wrench_lucide_react__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .A, {
                        className: "size-4",
                        "aria-hidden": true
                    }) : /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_barrel_optimize_names_ArrowDown_ArrowUp_BookOpen_Check_Copy_LogOut_Moon_PanelLeft_PanelLeftClose_Sun_Wrench_lucide_react__WEBPACK_IMPORTED_MODULE_14__/* ["default"] */ .A, {
                        className: "size-4",
                        "aria-hidden": true
                    })
                })
    ...
    const showToolsPopup = toolButtons.length > 1;
    // Reading mode: exit button at top-right, scroll buttons at bottom-right
    if (readingMode) {
        return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
            children: [
                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("nav", {
                    ...
                    className: "fixed top-4 right-8 z-310 animate-in fade-in duration-200",
                    children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_button__WEBPACK_IMPORTED_MODULE_6__/* .Button */ .$, {
                        type: "button",
                        variant: "ghost",
                        size: "icon",
                        title: t('exitReadingMode'),
                        "aria-label": t('exitReadingMode'),
                        onClick: handleToggleReadingMode,
                        className: `${toolButtonClass} size-9`,
                        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_barrel_optimize_names_ArrowDown_ArrowUp_BookOpen_Check_Copy_LogOut_Moon_PanelLeft_PanelLeftClose_Sun_Wrench_lucide_react__WEBPACK_IMPORTED_MODULE_15__/* ["default"] */ .A, {
                            className: "size-4",
                            "aria-hidden": true
                        })
                    })
                ...
                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("nav", {
                    role: "navigation",
                    "aria-label": t('pageActions'),
                    className: "fixed bottom-8 right-8 z-310 flex flex-col gap-2 animate-in fade-in duration-200",
                    children: [
                        /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_button__WEBPACK_IMPORTED_MODULE_6__/* .Button */ .$, {
                            ...
                            children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_barrel_optimize_names_ArrowDown_ArrowUp_BookOpen_Check_Copy_LogOut_Moon_PanelLeft_PanelLeftClose_Sun_Wrench_lucide_react__WEBPACK_IMPORTED_MODULE_16__/* ["default"] */ .A, {
                                className: "size-4",
                                "aria-hidden": true
                            })
                        }),
                        /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_button__WEBPACK_IMPORTED_MODULE_6__/* .Button */ .$, {
                            ...
                            className: paginationButtonClass,
                            children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_barrel_optimize_names_ArrowDown_ArrowUp_BookOpen_Check_Copy_LogOut_Moon_PanelLeft_PanelLeftClose_Sun_Wrench_lucide_react__WEBPACK_IMPORTED_MODULE_17__/* ["default"] */ .A, {
                                className: "size-4",
                                "aria-hidden": true
                            })
                        })
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("nav", {
        ...
        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("ul", {
            ...
            children: [
                !showToolsPopup && toolButtons.length === 1 && toolButtons[0].button,
                showToolsPopup && /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
                    children: [
                        /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
                            ref: popupRef,
                            className: `flex flex-col gap-2 overflow-hidden transition-all duration-200 ease-out ${popupOpen ? 'max-h-60 opacity-100' : 'max-h-0 opacity-0 pointer-events-none'}`,
                            children: toolButtons.map((tb)=>tb.button)
                        }),
                        /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("li", {
                            children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_button__WEBPACK_IMPORTED_MODULE_6__/* .Button */ .$, {
                                ...
                                className: `${toolButtonClass} relative ${popupOpen ? 'rotate-90' : ''}`,
                                children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_barrel_optimize_names_ArrowDown_ArrowUp_BookOpen_Check_Copy_LogOut_Moon_PanelLeft_PanelLeftClose_Sun_Wrench_lucide_react__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .A, {
                                    className: "size-4",
                                    "aria-hidden": true
                                })
                            })
...
;
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 95025));
;
...
;
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 92595));
;
...
;
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 37444));
;
...
/******/ __webpack_require__.O(0, [4785,5424,1032,2362,1831,9510,9367,9589,3888,458,2941,2995,1989,335,6201,1931,2715,8441,3794,7358], () => (__webpack_exec__(54914)));
